    ...
    return (
      <div id='procedures_list'>
        ...
        <div className='procedure-wrap'>
          {!this.props.isOpenServices && filter === '' ? this.state.categories.map(i => <div key={i.id} data_id={i.id} className='extended-category' onClick={() => this.handleclickCategory(i.id)}><div className='category'>
