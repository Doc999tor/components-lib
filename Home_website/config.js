      ...
      data: {
        basic: {
          ...
          opened_preview: {
            ...
            price_yearly: '/year',
            features: [
              { text: '100 Appointments monthly', is_important: true},
              { text: 'Available on 1 Device', is_important: false },
              { text: 'Text message reminders', is_important: true },
              { text: 'Client management', is_important: false},
              { text: 'Sync with Google Calendar', is_important: true},
            ],
        ...
        premium: {
          ...
          opened_preview: {
            ...
            features: [
              { text: 'Unlimited Appointments', is_important: true },
              { text: 'Available on 2 Devices', is_important: false },
              { text: 'Text message reminders', is_important: true},
              { text: 'Client management', is_important: false},
              { text: 'Client management', is_important: true},
              { text: 'Sync with Google Calendar', is_important: true},
              { text: 'Sync across devices', is_important: false},
              { text: 'Group appoinments', is_important: true},
              { text: 'Recurring appointments', is_important: false},
              { text: 'Messages without our branding', is_important: true},
              { text: 'Priority support', is_important: false}
            ],
        ...
        ultimate: {
          ...
          opened_preview: {
            ...
            features: [
              { text: 'Unlimited Appointments', is_important: true },
              { text: 'Unlimited Devices', is_important: true },
              { text: 'Text message reminders', is_important: true },
              { text: 'Client management', is_important: false },
              { text: 'Sync with Google Calendar', is_important: false },
              { text: 'Sync across devices', is_important: false },
              { text: 'Group appoinments', is_important: true },
              { text: 'Recurring appointments', is_important: false },
              { text: 'Messages without our branding', is_important: false },
              { text: 'Priority support', is_important: true },
            ],
            not_included_features: [],
